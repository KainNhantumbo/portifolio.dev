  ...
  return (
    <main className='w-full h-[100vh] grid place-content-center place-items-center'>
      ...
      <section className='flex flex-col items-center gap-5'>
        ...
        <h2 className='font-bold font-sans text-primary uppercase'>Page not found</h2>
        ...
        <Link
          href={'/'}
          className='rounded-3xl font-medium font-sans border-solid border-[2px] border-font mt-5 p-2 px-5 hover:border-primary hover:text-primary transition-colors '>
          Take me home
        </Link>
      </section>
    </main>
