	...
	return (
		<>
			...
			<Container>
				...
				<article>
					<p>
						A sua privacidade é importante para nós. É política do MealBlast
						respeitar a sua privacidade em relação a qualquer informação sua que
						possamos coletar no site{' '}
						<a href='mealblast.vercel.app'>MealBlast</a>, e outros sites que
					...
					<p>
						O nosso site pode ter <em>links</em> para sites externos que não são
					...
					<h2>Política de Cookies MealBlast</h2>
					...
					<ul>
						<li>
							...
							<br></br> Se você criar uma conta connosco, usaremos cookies para
							o gerenciamento do processo de inscrição e administração geral.
						...
						<li>
							...
							<br></br> Utilizamos cookies quando você está logado, para que
						...
						<li>
							...
							<br></br> Este site oferece serviços de assinatura de boletim
							informativo ou e-mail e os cookies podem ser usado para lembrar se
						...
						<li>
							...
							<br></br> Quando você envia dados por meio de um formulário como
						...
						<li>
							...
							<br></br> Para proporcionar uma ótima experiência neste site,
							...
							página for afetada por suas preferências.<br></br>{' '}
						</li>
					</ul>
					...
					<p>
						...
						informação que o <strong>MealBlast</strong> oferece no site e com
					...
					<ul>
						...
						<li>
							...
							xenofóbica,{' '}
							<a href='https://ondeapostar.pt/onde-da-a-bola/'>
								Onde dá a Bola
							</a>{' '}
						...
						<li>
							...
							(softwares) da <strong>MealBlast</strong>, de seus fornecedores ou
					...
					<p>
						Esta política é efetiva a partir de <strong>Junho de 2022</strong>.
					</p>
				</article>
			</Container>
			<Footer />
